...
public class RotiTawar extends AdonanRotiTawar implements Filling{
    ...
    public void varian1(int x){
        System.out.println("RotiTawar varian 1 sebanyak " + x + " pcs");
        System.out.println("=======================================");
        ...
        System.out.println("Coklat " + x*80 + " gram seharga Rp " + this.fillingCoklat(80));
        System.out.println("Harga per pcs : Rp " + Math.round((150/100)*(hargaTepungTeriguRotiTawarPcs + hargaGulaPasirRotiTawarPcs + hargaButterRotiTawarPcs + hargaRagiRotiTawarPcs + hargaSusuBubukRotiTawarPcs + hargaSusuCairRotiTawarPcs + hargaTelurRotiTawarPcs + hargaEsBatuRotiTawarPcs + this.fillingCoklat(80))));
        System.out.println("Harga Total : Rp " + Math.round(x * ((150/100)*(hargaTepungTeriguRotiTawarPcs + hargaGulaPasirRotiTawarPcs + hargaButterRotiTawarPcs + hargaRagiRotiTawarPcs + hargaSusuBubukRotiTawarPcs + hargaSusuCairRotiTawarPcs + hargaTelurRotiTawarPcs + hargaEsBatuRotiTawarPcs + this.fillingCoklat(80)))));
    }
    ...
    public void varian2(int x){
        ...
        System.out.println("=======================================");
        System.out.println("Filling : ");
        System.out.println("Keju " + x*80 + " gram seharga Rp " + this.fillingKeju(80));
